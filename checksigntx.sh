...
if [ "$address1" != "$address2" ]; then
 ...
 echo "---------------------------------------------------------------------------------------------------------------------"
echo -e " Node signed   the block \033[32m $counter1 \033[0m  times "
echo -e " Node proposed the block \033[32m $counter2 \033[0m  times"
echo -e "\033[32m PRESS -- CTRL+C -- TO EXIT \033[0m "
fi
sleep 0.2
